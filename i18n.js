(() => {
  ...
  const translations = {
    en: {
      ...
      'drawboard.submitPrompt': 'Do you also want to submit this image for review so it may become a permanent part of the public gallery? Click OK to open a GitHub issue, or Cancel to keep it local only.',
      'drawboard.submission.titlePrefix': 'Gallery submission',
      'drawboard.submission.imageName': 'Image name',
      'drawboard.submission.instructions': 'Please drag and drop the PNG file your browser just downloaded into this issue body, then submit. The owner will review it and create a pull request automatically.',
      'drawboard.submission.opening': 'Opening submission form…',
      'drawboard.submission.opened': 'Saved locally. Please complete the submission in the new tab.',
    ...
    de: {
      ...
      'drawboard.submitPrompt': 'Möchtest du dieses Bild auch zur Prüfung einreichen, damit es fix Teil der öffentlichen Galerie werden kann? OK öffnet ein GitHub-Issue, Abbrechen speichert es nur lokal.',
      'drawboard.submission.titlePrefix': 'Galerie-Einreichung',
      'drawboard.submission.imageName': 'Bildname',
      'drawboard.submission.instructions': 'Bitte ziehe die PNG-Datei, die dein Browser gerade heruntergeladen hat, in dieses Issue und sende es ab. Roger schaut es an und ein Pull Request wird automatisch erstellt.',
      'drawboard.submission.opening': 'Einreichungsformular wird geöffnet…',
      'drawboard.submission.opened': 'Lokal gespeichert. Bitte schliess die Einreichung im neuen Tab ab.',
    ...
    fr: {
      ...
      'drawboard.submitPrompt': 'Voulez-vous aussi soumettre cette image pour examen afin qu’elle puisse intégrer la galerie publique? OK ouvre un ticket GitHub, Annuler la garde uniquement en local.',
      'drawboard.submission.titlePrefix': 'Soumission galerie',
      'drawboard.submission.imageName': 'Nom de l’image',
      'drawboard.submission.instructions': 'Veuillez glisser-déposer le fichier PNG que votre navigateur vient de télécharger dans le corps du ticket, puis envoyer. Le propriétaire l’examinera et une pull request sera créée automatiquement.',
      'drawboard.submission.opening': 'Ouverture du formulaire de soumission…',
      'drawboard.submission.opened': 'Enregistré localement. Veuillez compléter la soumission dans le nouvel onglet.',
    ...
    it: {
      ...
      'drawboard.submitPrompt': 'Vuoi anche inviare questa immagine per la revisione affinché possa entrare nella galleria pubblica? OK apre una issue GitHub, Annulla la mantiene solo in locale.',
      'drawboard.submission.titlePrefix': 'Invio galleria',
      'drawboard.submission.imageName': 'Nome immagine',
      'drawboard.submission.instructions': 'Trascina il file PNG appena scaricato dal tuo browser nel corpo della issue, quindi invia. Il proprietario esaminerà l’immagine e creerà automaticamente una pull request.',
      'drawboard.submission.opening': 'Apertura del modulo di invio…',
      'drawboard.submission.opened': 'Salvato localmente. Completa l’invio nella nuova scheda.',
    ...
    rm: {
      ...
      'drawboard.submitPrompt': 'Vuls ti era inoltrar quest maletg per la revisiun, per ch\'el possia daventar part fixa da la galaria publica? OK avra in issue GitHub, Interrumper al tegna mo localmain.',
      'drawboard.submission.titlePrefix': 'Inoltraziun galaria',
      'drawboard.submission.imageName': 'Num dal maletg',
      'drawboard.submission.instructions': 'Per plaschair trair la datoteca PNG che tes navigatur ha gist telechargià en il corp da quest issue ed al trametter. Il possessur al revedrà ed in pull request vegn creà automaticamain.',
      'drawboard.submission.opening': 'Avrir il formular d\'inoltraziun…',
      'drawboard.submission.opened': 'Salvà localmain. Per plaschair finescha l\'inoltraziun en il nov tab.',
